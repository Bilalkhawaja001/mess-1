...
<div class="card shadow-sm mb-3">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route('admin.member-accounts.store') }}" class="row g-2">
            ...
            <div class="col-md-3"><input type="password" name="password_confirmation" class="form-control" placeholder="Confirm password" required></div>
...
<div class="card shadow-sm">
    ...
    <div class="card-body table-responsive">
        <table class="table table-sm align-middle">
            <thead><tr><th>Member</th><th>Mobile</th><th>User</th><th>Portal</th><th>Mobile Verified</th><th>Actions</th></tr></thead>
            <tbody>
            @foreach($members as $m)
                <tr>
