...
<head>
    ...
    <title>@yield('title', 'NODESKY Mess Billing')</title>
...
<div class="auth-shell">
    <aside class="auth-aside">
        <div>
            ...
            <h1 class="display-6 fw-bold mb-3">NODESKY Mess Billing Portal</h1>
            ...
            <div class="row g-3">
                ...
                <div class="col-sm-6">
                    <div class="p-3 rounded-4 border border-light border-opacity-25 bg-white bg-opacity-10 h-100">
                        <div class="fw-semibold mb-1">Branded Experience</div>
                        <div class="small text-white-50">Unified NODESKY identity across authentication, dashboard, forms, and data surfaces.</div>
                    </div>
                </div>
            </div>
        </div>
        <div class="auth-footer">Powered by NODESKY (SMC-PRIVATE) LIMITED</div>
    </aside>
